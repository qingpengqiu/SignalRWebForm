 ...
 **************************提示********************************/
//var URL0 = "http://img.erun360.com/Utility/Uploads/";
var URL0 = "http://114.247.234.229:8081/Utility/Uploads/";
(function () {
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        , imagePath: URL0 + ""                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:3500                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中

        //涂鸦图片配置区
        ,scrawlUrl:URL+"net/scrawlUp.ashx"           //涂鸦上传地址
        , scrawlPath: URL0 + ""                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"net/fileUp.ashx"               //附件上传提交地址
        , filePath: URL0 + ""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
       // ,catcherUrl:URL +"net/getRemoteImage.ashx"   //处理远程图片抓取的地址
        //, catcherPath: URL0 + ""                  //图片修正地址，同imagePath
        ...
        , imageManagerPath: URL0 + ""                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|',
             ...
             'link', 'unlink', 'anchor', 'indent','insertimage', 'emotion','insertvideo','music', 'gmap', 'horizontal', 
...
//        }
        ...
        ,initialFrameHeight:570  //初始化编辑器高度,默认320
...
//           ]
        ...
        ,wordOverFlowMsg:'<span style="color:red;">你输入的字符个数已经超出最大允许值8000，服务器可能会拒绝保存！</span>'    //<span style="color:red;">你输入的字符个数已经超出最大允许值，服务器可能会拒绝保存！</span>
