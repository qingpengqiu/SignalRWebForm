<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="_Utility_Search" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title><% =PageWord %>-ERUN360.COM</title>
...
<div id="blog_b">
	<div id="blog_b_1">
		...
		<div id="blog_title" class="blog_title1">
			<font style="font-size:24px;"><% =PageWord %></font><br>
			<br>
			<br>
			<div id="blog_guide">
...
$.get("/Utility/Ajax/UserSummery.aspx", { rnd : Math.random() }, function(result) {
	if(result.length > 0) {
...
$.get("/Utility/Ajax/BlogGroupInfo.aspx", { }, function(result) {
	if(result.length > 0) {
