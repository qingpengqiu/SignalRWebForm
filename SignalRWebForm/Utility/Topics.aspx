<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Topics.aspx.cs" Inherits="_Utility_Topics" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title><% =PageName %>专栏-ERUN360.COM</title>
...
<div id="blog_b">
	<div id="blog_b_1">
		...
		<div id="blog_title" class="blog_title1">
			<font style="font-size:24px;"><% =PageName %> - 专栏</font><br>
			<% =PageUser %><br>
			<a href="<% =UrlHelper.TopicsUrl(TopicsIndex) %>">http://www.erun360.com<% =UrlHelper.TopicsUrl(TopicsIndex) %></a><br>
			<div id="blog_guide">
				<% =PageGuide %>
			</div>
		</div>
