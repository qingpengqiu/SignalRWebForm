<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BindMobile.aspx.cs" Inherits="infocenter_BindMobile" %>
...
<div class="rebox">
    ...
    <div class="refrome refi">
        <form id="form">
            <input type="hidden" value="bindmobile" name="op" id="op">
            <div class="newregist">
...
$(".getmsgcode").click(function(event) {
    ...
    if ($(this).data("get") == 1 || $(this).data("get") == 3) {
        var tel = $("#mobile").val(),
            code = $("#txtCode").val()
        $.get('/action/ajaxsms.ashx?op=sendsms&type=bindmobile&mobile=' + tel + '&code=' + code, function (data) {
            if (data.status == 1) {
