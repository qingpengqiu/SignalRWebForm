...
public partial class Competetion_tblAnnex : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (id != 0)
            {
                ds = new DB6.tblAnnex().GetList(0, "idCompete=" + id, "idCompete desc");
            }
            else
            {
                ds = new DB6.tblAnnex().GetList(0, "", "idCompete desc");
            }//帮顶附属产品列表
