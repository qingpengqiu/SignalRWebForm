        ...
        <div class="mine">
            ...
            <div class="tbodyBox">
                <div class="event this clearfix">
                	<div class="eqma">
                		<div class="eqmal">
                			<a class="eqmaa eqmajd" href="tblAnnex.aspx?sid=<%=sid %>">附加项管理<i></i></a>
                		</div>
                		<div class="eqmar am-form ">
                                <div class="fbtitle">添加附加项
                			<div class="fbli">
                				<div class="fblil"><label>产品名称：</label></div>
                            ...
                            <div class="savefb">
                			<asp:Button ID="but_save" runat="server"   class="fkbuttom" Text="保存" OnClick="but_save_Click" ></asp:Button>
                            </div>
                        </div>
                	</div>
                </div>
