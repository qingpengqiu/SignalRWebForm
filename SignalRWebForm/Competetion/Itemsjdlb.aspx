<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Itemsjdlb.aspx.cs" Inherits="Competetion_Itemsjdlb" %>
                ...
                <div class="event this clearfix">
                	<div class="eqma">
                		...
                		<div class="eqmar am-form ">
                                <div class="fbtitle">酒店列表/<a  class="addproject" href="Itemsjd.aspx?id=0&sid=<%=sid%>" >添加酒店</a>
<div class="auditclub">
                        ...
                        <tr>
                           ...
                           <td><%# DataBinder.Eval(Container.DataItem, "cName")%></td>                            
                            ...
                            <td><%# DataBinder.Eval(Container.DataItem, "iBuyMax")%></td>                            
                             <td><a href='<%# "Itemsjd.aspx?id="+DataBinder.Eval(Container.DataItem, "id")+"&sid="+DataBinder.Eval(Container.DataItem, "idCompete") %>' >编辑</a>
                             </td>
                        </tr>
                    </ItemTemplate>
