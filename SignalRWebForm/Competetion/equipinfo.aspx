<%@ Page Language="C#" AutoEventWireup="true" CodeFile="equipinfo.aspx.cs" Inherits="Competetion_equipinfo" %>
    ...
    <div class="mine">
        ...
        <div class="tbodyBox">
            <div class="event this clearfix">
                <a class="backlisteq" href="/Competetion/equipment.aspx?sid=<%=sid %>&nav=8">>返回装备列表</a>
                <div class="equipinfo">                       
...
<div class="dpbox equitopbox" id="dpbox">
    <div class="dptitle">装备预订 <i></i></div>
    <div class="equinbox am-form hoteltbox">
        ...
        <hr>
            <input type='hidden' value='tjzb' name="op">
...
$(".equilgo").click(function(event) {
    ...
    if (onsize == 1 && oncolor == 1) {
        ...
        $(".toast").html('请选择尺码和颜色').show().addClass('toast-error')
        errorboxhide()
    }
});
