...
public partial class Competetion_ItemsjbAdd : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (model != null)
            {
                ...
                cHotelName.Value = model.cItemName.ToString();
    ...
    protected void but_save_Click(object sender, EventArgs e)
    {
        ...
        modl.cItemName = cHotelName.Value;
        ...
        if (cout)
        {
            DataSet ds = new DB6.tblHotel_Item().GetList("idHotel='" + itemid + "'");
            ...
            if (isum != 0)
            {
                DBM6.tblHotel ddmodl = new DBM6.tblHotel();
                ddmodl.id = itemid;
                ddmodl.iTotal = isum;
                new DB6.tblHotel().Update(ddmodl);
            }
            AlertHelper.JQAlertGo("修改成功！", "Itemsjd.aspx?id="+ itemid +"&sid=" + idcompete + "", true);
            return;
        }
        else
        {
