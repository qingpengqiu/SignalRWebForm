<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Itemsjd.aspx.cs" Inherits="Competetion_Itemsjd" %>
        ...
        <div class="mine">
            ...
            <div class="tbodyBox">
                <div class="event this clearfix">
                	<div class="eqma">
                		<div class="eqmal">
                			<a class="eqmaa eqmajd" href="Itemsjdlb.aspx?id=0&sid=<%=idcompete %>">酒店管理<i></i></a>
                		</div>
                		<div class="eqmar am-form ">
                			<div class="fbtitle">添加酒店<a class="fbadd">发布酒店信息</a></div>
                			<div class="fbli">
                				<div class="fblil"><label>酒店名称：</label></div><div class="fblir"><input id="Cname" runat="server" type="text" class="am-form-field am-radius fbftitle" placeholder="" style="width: 385px"></div>
                			</div>
                            <div class="fbli">
                                <div class="fblil"><label>排序：</label></div>
                                <div class="fblir">
                                    <input id="px" runat="server" type="text" class="am-form-field am-radius fb82" placeholder="">
                                    <label>按值大小排序</label>
                                </div>
                            </div>
                            <div class="fbli">
                                ...
                                <div class="fblir">
                                <input id="dRaceBegin" runat="server" name="dRaceBegin" type="text" style="width: 185px" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm',maxDate:'#F{$dp.$D(\'dRaceEnd\')}'})" class="am-form-field am-radius fb82" />
                                -<input id="dRaceEnd" runat="server" name="dRaceEnd" type="text" style="width: 185px" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'dRaceBegin\')}'})" class="am-form-field am-radius fb82"/>
                                </div>
                            </div>
                			<div class="fbli">
                				<div class="fblil"><label>每个ID最大购买数：</label></div>
                                <div class="fblir">
                                    <%--<input id="iTotal" type="text" class="am-form-field am-radius fb82" placeholder="" runat="server">--%><input type="text" runat="server" tabindex="4" id="iBuyMax" maxlength="9" class="am-form-field am-radius fb82" /></div>
                			</div>
                            <div class="fbli">
                            ...
                            <div class="fbli">
                                <div class="fblil"><a href="javascript:void(0)" class="add-records">+添加房型</a><%--<asp:Button ID="Button1" runat="server"  class="fkbuttom" Text="添加款式" OnClick="Button1_Click" ></asp:Button>--%></div>
                            </div>
                             <script src="../UEditor/ueditor.config.js"></script>
                            <script src="../UEditor/ueditor.all.js"></script>

                            <div class="fbli">
                				<div class="fblil"><label>酒店政策：</label></div>
                			...
                			<div class="fbli">
                				<div class="fblil"><label>酒店介绍：</label></div>
                				<div class="fblir fbtext">
                            ...
                            <div class="fbli">
                				<div class="fblil"><label>酒店设施：</label></div>
                				<div class="fblir fbtext">
