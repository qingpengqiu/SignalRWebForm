<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemsjdAdd.aspx.cs" Inherits="Competetion_ItemsjbAdd" %>
                ...
                <div class="event this clearfix">
                    <div class="eqma">
                        ...
                        <div class="eqmar am-form " aria-haspopup="False">
                            <div class="fbtitle">编辑酒店</div>
                            <div class="fbli">
                                <div class="fblil"><label>房型：</label></div>
                                <div class="fblir">
                                    <input type="text" runat="server" tabindex="4" id="cHotelName" maxlength="9" class="am-form-field am-radius fbftitle"/>
                                </div>
                            </div>
                            <div class="fbli">
                                <div class="fblil"><label>数量</label></div>
                                <div class="fblir">
                                    <input id="iLimit" type="text" class="am-form-field am-radius fb82" placeholder="" runat="server">
                                </div>
                            </div>
                            <div class="fbli">
