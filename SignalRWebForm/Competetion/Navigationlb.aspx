<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Navigationlb.aspx.cs" Inherits="Competetion_Navigationlb" %>
                    ...
                    <div class="event this clearfix">
                        <div class="eqma">
                            ...
                            <div class="eqmar am-form ">
                                <div class="fbtitle">
                                    导航列表/<a class="addproject" href="Navigation.aspx?id=0&sid=<%=sid%>">添加导航</a>
                                    <div class="auditclub">
                                        <asp:Repeater ID="rptrunrecord" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%# DataBinder.Eval(Container.DataItem, "idname")%></td>
                                                    <td><a href='<%# "Navigation.aspx?sid="+DataBinder.Eval(Container.DataItem, "idCompete") %>'>编辑</a>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
