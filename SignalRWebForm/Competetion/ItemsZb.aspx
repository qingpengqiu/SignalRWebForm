<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemsZb.aspx.cs" Inherits="Competetion_ItemsZb" %>
        ...
        <div class="mine">
            ...
            <div class="tbodyBox">
                <div class="event this clearfix">
                	<div class="eqma">
                		<div class="eqmal">
                			<a class="eqmaa eqmazb" href="ItemsZblb.aspx?sid=<%=idcompete %>">装备管理<i></i></a>
                		</div>
                		<div class="eqmar am-form ">
                			<div class="fbtitle">添加装备<a class="fbadd">发布装备信息</a></div>
                			<div class="fbli">
                				<div class="fblil"><label>商品名称：</label></div><div class="fblir"><input id="Cname" runat="server" type="text" class="am-form-field am-radius fbftitle" placeholder="" style="width: 385px"></div>
                			</div>
                            <div class="fbli">
                			...
                			<div class="fbli">
                                ...
                                <div class="fblir">
                                  <%--  <input id="iTotal" type="text" class="am-form-field am-radius fb82" placeholder="" runat="server"><label>：</label>--%><input type="text" runat="server" tabindex="4" id="iBuyMax" maxlength="9" class="am-form-field am-radius fb82" /></div>
                			</div>
                            <div class="fbli">
                            ...
                            <div class="fbli">
                                ...
                                <div class="fblir">
                                    <input type="file" class="input-large fileupload"><input type="hidden" id="hdtt" name="hdtt" runat="server"/><%--<img src="<%=src %>" id="tpimg" width="30" height="30"/>--%>
                            ...
                            <div class="fbli">
                                <div class="fblil"><a href="javascript:void(0)" class="add-records">+添加款式</a><%--<asp:Button ID="Button1" runat="server"  class="fkbuttom" Text="添加款式" OnClick="Button1_Click" ></asp:Button>--%></div>
                            </div>
                			<div class="fbli">
                           ...
                           <%-- <div class="fbli">
                                <div class="fblil"><label>显示区域：</label></div>
                                <div class="fblir">
                                    <select id="iGlobal" runat="server" tabindex="1" style="width: 200px;"> 
                                <option value="0">所有赛事下显示</option>
                                <option value="1">当前赛事下显示</option>
                            </select>
                                </div>
                            </div>--%>
                			<div class="fbli">
