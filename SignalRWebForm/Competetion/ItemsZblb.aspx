<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemsZblb.aspx.cs" Inherits="Competetion_ItemsZblb" %>
                ...
                <div class="event this clearfix">
                	<div class="eqma">
                		...
                		<div class="eqmar am-form ">
                                <div class="fbtitle">装备列表/<a  class="addproject" href="ItemsZb.aspx?id=0&sid=<%=sid%>" >添加装备</a>
<div class="auditclub">
                        ...
                        <tr>
                           ...
                           <td><%# DataBinder.Eval(Container.DataItem, "cName")%></td>                            
                            ...
                            <td><%# DataBinder.Eval(Container.DataItem, "iBuyMax")%></td>                            
                             <td><a href='<%# "ItemsZb.aspx?id="+DataBinder.Eval(Container.DataItem, "id")+"&sid="+DataBinder.Eval(Container.DataItem, "idCompete") %>' >编辑</a>
                             </td>
                        </tr>
                    </ItemTemplate>
