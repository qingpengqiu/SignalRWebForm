...
namespace Com.Alipay.Wap
{
    ...
    public class Submit
    {
        ...
        static Submit()
        {
            _key = Com.Alipay.Wap.Config.Key;
            _private_key = Com.Alipay.Wap.Config.Private_key;
        ...
        private static string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            {
                case "MD5":
                    mysign = Com.Alipay.Wap.AlipayMD5.Sign(prestr, _key, _input_charset);
                    break;
                case "RSA":
                    mysign = Com.Alipay.Wap.RSAFromPkcs8.sign(prestr, _private_key, _input_charset);
                    break;
                case "0001":
                    mysign = Com.Alipay.Wap.RSAFromPkcs8.sign(prestr, _private_key, _input_charset);
                    break;
        ...
        private static string BuildRequestParaToString(Dictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = Com.Alipay.Wap.Core.CreateLinkStringUrlencode(sPara, code);
