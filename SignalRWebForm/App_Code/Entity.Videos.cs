...
namespace ERUN360.Entity
{
    ...
    public class VideosInfo
    {
        ...
        // 视频地址
        private string _cVideoUrl = String.Empty;
        public string cVideoUrl
        {
            get { return _cVideoUrl; }
            set { _cVideoUrl = XString.SqlSafe((string)value); }
        }
        // 缩略图地址
    ...
    public class Videos : SQLHelper
    {
        ...
        // 数据库.表.名称
        private static string Database = "[YP_DB_3].[dbo].[tblVIDEOS]";
        ...
        /// <param name="item">VideosInfo</param>
        /// <return>成功返回true，失败返回false</return>
        public bool Update(VideosInfo item)
        {
            ...
            _s.Append("cVideoUrl='" + item.cVideoUrl.ToString() + "',");
        ...
        /// <param name="item">VideosInfo</param>
        /// <return>成功返回true，失败返回false</return>
        public bool UpdateBy(VideosInfo item, string fieldName, string fieldValue)
        {
        ...
        /// </summary>
        /// <param name="id"></param>
        /// <return>VideosInfo</return>
        public VideosInfo Load(int local_id, string fieldName, string fieldValue)
        {
            if (local_id <= 0) { _err = "local_id <= 0"; return null; }
            VideosInfo item = null;
            string sql = "";
            ...
            try
            {
                ...
                if (sr.Read())
                {
                    ...
                    item.cVideoUrl = sr["cVideoUrl"].ToString();
        ...
        /// <return>VideosInfo List</return>
        public List<VideosInfo> PageList(int pageIndex, int pageSize, string conditionString, string orderString, out int pageCount)
        {
            // 预先赋值
            pageCount = 0;
            // 检测页号
            ...
            List<VideosInfo> list = new List<VideosInfo>();
            string sql = "";
            // 查询总数并计算总页数
            ...
            try
            {
                ...
                while (sr.Read())
                {
                    VideosInfo item = new VideosInfo();
                    item.id = Int32.Parse(sr["id"].ToString());
                    item.idUser = Int32.Parse(sr["idUser"].ToString());
                    item.idInfo = Int32.Parse(sr["idInfo"].ToString());
                    item.cVideoUrl = sr["cVideoUrl"].ToString();
