...
<html>
<head>
<title>跑步,健康,伤病恢复-ERUN360.COM</title>
...
<div class="indecen">
	<div class="left">
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(305111100) %>" class="httitle">跑步与健康</a>
			<% =pf.Show(305111100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(305112100) %>" class="httitle">伤病恢复</a>
			<% =pf.Show(305112100) %>
		</div>
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(305113100) %>" class="httitle">身体解密</a>
			<% =pf.Show(305113100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(305114100) %>" class="httitle">其它</a>
			<% =pf.Show(305114100) %>
		</div>		
	</div>
	<div class="right">
