<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Channels_Life_Default" %><%@ Register Src="~/Controls/Erun_Footer.ascx" TagPrefix="ERUN360" TagName="Erun_Footer" %><%@ Register Src="~/Controls/Erun_Header.ascx" TagPrefix="ERUN360" TagName="Erun_Header" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title>跑步人生-ERUN360.COM</title>
...
<div class="indecen">
	<div class="left">
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(313111100) %>" class="httitle">草根英雄</a>
			<% =pf.Show(313111100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(313112100) %>" class="httitle">明星名人</a>
			<% =pf.Show(313112100) %>
		</div>
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(313113100) %>" class="httitle">跑步随笔</a>
			<% =pf.Show(313113100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(313114100) %>" class="httitle">跑步书籍</a>
			<% =pf.Show(313114100) %>
		</div>		
	</div>
	<div class="right">
