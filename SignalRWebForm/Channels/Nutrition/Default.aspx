...
<div class="indecen">
	<div class="left">
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(304111100) %>" class="httitle">饮食.保健</a>
			<% =pf.Show(304111100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(304112100) %>" class="httitle">健康减肥</a>
			<% =pf.Show(304112100) %>
		</div>
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(304113100) %>" class="httitle">竞赛.补剂</a>
			<% =pf.Show(304113100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(304114100) %>" class="httitle">食谱食材</a>
			<% =pf.Show(304114100) %>
		</div>		
	</div>
	<div class="right">
