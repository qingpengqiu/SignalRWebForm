...
<style>
.nav li.h_xl em {background: url(/Images/index/adqbj.png) no-repeat center 49px;}
</style>
...
<div class="indecen">
	<div class="left">
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(301113100) %>" class="httitle">一年级生</a>
			<% =pf.Show(301113100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(301114100) %>" class="httitle">系统训练</a>
			<% =pf.Show(301114100) %>
		</div>
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(301115100) %>" class="httitle">实用技巧</a>
			<% =pf.Show(301115100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(301116100) %>" class="httitle">如切如磋</a>
			<% =pf.Show(301116100) %>
		</div>		
	</div>
	<div class="right">
