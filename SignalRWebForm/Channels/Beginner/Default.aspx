<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Channels_Beginner_Default" %><%@ Register Src="~/Controls/Erun_Footer.ascx" TagPrefix="ERUN360" TagName="Erun_Footer" %><%@ Register Src="~/Controls/Erun_Header.ascx" TagPrefix="ERUN360" TagName="Erun_Header" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title>初级跑者-益跑网-ERUN360.COM</title>
...
<div class="indecen">
	<div class="left">
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(311111100) %>" class="httitle">为什么跑</a>
			<% =pf.Show(311111100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(311112100) %>" class="httitle">菜鸟入门</a>
			<% =pf.Show(311112100) %>
		</div>
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(311113100) %>" class="httitle">首次参赛</a>
			<% =pf.Show(311113100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(311114100) %>" class="httitle">新手问题</a>
			<% =pf.Show(311114100) %>
		</div>
		<div class="ht">
			<a href="<% =UrlHelper.TopicsUrl(311115100) %>" class="httitle">红粉跑者</a>
			<% =pf.Show(311115100) %>
		</div>
		<div class="ht htr">
			<a href="<% =UrlHelper.TopicsUrl(311116100) %>" class="httitle">跑步减肥</a>
			<% =pf.Show(311116100) %>
		</div>
	</div>
	<div class="right">
