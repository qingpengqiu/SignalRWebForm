<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RaceProject2.aspx.cs" Inherits="Channels_Competetion_RaceProject2" %><%@ Register Src="~/Controls/Erun_Footer.ascx" TagPrefix="ERUN360" TagName="Erun_Footer" %><%@ Register Src="~/Controls/Erun_Header.ascx" TagPrefix="ERUN360" TagName="Erun_Header" %><!DOCTYPE html>
            ...
            <div class="racebody">
                ...
                <div class="mprojectfrom">
                    ...
                    <div class="bmtable">
                        <div class="bmtr">
                            <div class="bmtd">
                                <span><label for="name"><asp:Literal ID="ltlName" runat="server"></asp:Literal></label></span>
                                    <em><input type="text" runat="server" value="" maxlength="16" tabindex="1" id="name" name="name" datatype="*1-30" errormsg="请填写真实姓名" nullmsg="请填写真实姓名" />
                        ...
                        <div class="bmtr">
                            ...
                            <div class="bmtd">
                                <span><label for="birthday"><asp:Literal ID="ltlBirthday" runat="server"></asp:Literal></label></span>
                                    <em><input type="text" runat="server" name="birthday" id="birday" value="" tabindex="4" onclick="GDate(this);" /></em>
                            </div>
                        </div>
                        <div class="bmtr">
                            <div class="bmtd">
                            ...
                            <div class="bmtd">
                                <span><label for="occupation"><asp:Literal ID="ltlOccupation" runat="server"></asp:Literal></label>
                                    ...
                                    <em><asp:DropDownList ID="idOccupation" runat="server" TabIndex="6"></asp:DropDownList></em>
                            </div>
                        </div>
                        <div class="bmtr">
                            <div class="bmtd">
                        ...
                        <div class="bmtr">
                            <div class="bmtd">
                                <span><label for="mobile"><asp:Literal ID="ltlMobile" runat="server"></asp:Literal></label>
                                    ...
                                    <em>
                                        <input type="text" name="mobile" id="mobile" value="" tabindex="9" runat="server" maxlength="11" />
                                        <div class="Validform_checktip"></div>
                                    </em>
                            </div>
                            <div class="bmtd">
                                <span><label for="email"><asp:Literal ID="ltlEmail" runat="server"></asp:Literal></label>
                                    ...
                                    <em>
                                        <input type="text" name="email" id="email" value="" tabindex="10" runat="server" maxlength="64" />
                                        <div class="Validform_checktip"></div>
                                    </em>
                            </div>
                        </div>
                        <div class="bmtr">
                            <div class="bmtd">
                                <span><label for="address"><asp:Literal ID="ltlAddress" runat="server"></asp:Literal></label></span>
                                    <em>
                                        <select tabindex="11" name="ddlProvince" id="ddlProvince" onchange="selectMoreCity(this)" runat="server" >
                                        </select>
                                        ...
                                        <input type="text" name="address" id="address" value="" tabindex="11" runat="server" maxlength="128" />
                                        <div class="Validform_checktip"></div>
                                    </em>
                            </div>
                            <div class="bmtd">
                                <span><label for="zipcode"><asp:Literal ID="ltlZipCode" runat="server"></asp:Literal></label></span>
                                    <em>
                                        <input type="text" name="zipcode" id="zipcode" value="" tabindex="12" runat="server" maxlength="6" />
                                        <div class="Validform_checktip"></div>
                                    </em>
                            </div>
                        </div>
                        <div class="bmtr">
                            <div class="bmtd">
                                <span><label for="emerger"><asp:Literal ID="ltlEmerger" runat="server"></asp:Literal></label></span>
                                    <em>
                                        <input type="text" name="emerger" id="emerger" value="" tabindex="13" runat="server" maxlength="30" />
                                        <div class="Validform_checktip"></div>
                                    </em>
                            </div>
                            <div class="bmtd">
                                <span class="sosp"><label for="emermobile"><asp:Literal ID="ltlEmermobile" runat="server"></asp:Literal></label></span>
                                    <em>
                                        <input type="text" name="emermobile" id="emermobile" value="" tabindex="14" runat="server" maxlength="30" />
                                        <div class="Validform_checktip"></div>
                                    </em>
                            </div>
                        </div>
                        <div class="bmtr tdlabele">
                            <div class="bmtd" runat="server" id="idsize">
                                <span><label for="competetion"><asp:Literal ID="ltlShirts" runat="server"></asp:Literal></label></span>
                                    <em>
                                        <asp:DropDownList ID="size" runat="server"  TabIndex="15">
