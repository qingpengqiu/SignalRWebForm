...
public partial class Channels_Competetion_RaceProject2 : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (iAbroad == 1)
            {
                Response.Redirect("/Channels/Competetion/RaceAbroad.aspx?idcompete=" + id + "&la=" + la + "&p=" + idItem + "&o=" + idAdd + "&integral=" + iFlag, true);
            }
            #region 用户报名信息
    ...
    protected void btSubmit_Click(object sender, EventArgs e)
    {
        ...
        modelsales.idNationIDType = TypeChange.NullToInt(ddlCard.SelectedValue, 1);//证件类型
        ...
        model.cAddress = address.Value.Trim();//地址
