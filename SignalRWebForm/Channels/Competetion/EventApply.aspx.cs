...
public partial class Channels_Competetion_EventApply : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            idOccupation.SelectedValue = TypeChangeDefault.NullToString(user.idOccupation, "21");
    ...
    {
        string path = Server.MapPath("/XML/Stringsen.xml");
        DataSet ds = new DataSet();
        ds.ReadXml(path);
        string CacheKey = "idOccupation-en";
        object objModel = null;// Erun360.Common.DataCache.GetCache(CacheKey);
        if (objModel == null)
        {
            try
            {
