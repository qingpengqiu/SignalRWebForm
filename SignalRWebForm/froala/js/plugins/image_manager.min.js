...
function(a) {
    ...
    if (a.extend(a.FE.DEFAULTS, {
        imageManagerLoadURL: "/action/ajaxphoto.ashx?op=getphoto",
        imageManagerLoadMethod: "get",
        imageManagerLoadParams: {},
        imageManagerPreloader: "",
        imageManagerDeleteURL: "/action/ajaxphoto.ashx",
        ...
        function d() {
            ...
            z.hide(),
            F.hide(),
            b.$doc.find("body").removeClass("prevent-scroll fr-mobile")
        }
        function e() {
        ...
        function g() {
            ...
            d += "</div>",
            d += '<img class="fr-preloader" id="fr-preloader" alt="' + b.language.translate("Loading") + '.." src="' + b.opts.imageManagerPreloader + '" style="display: none;">',
            d += '<div class="fr-scroller" id="fr-scroller"><div class="fr-image-list" id="fr-image-list"></div></div>',
            d += "</div></div>",
            a(d)
        }
        function h() {
            b.shared.$modal ? (z = b.shared.$modal, F = b.shared.$overlay) : (b.shared.$modal = g(), z = b.shared.$modal, b.helpers.isMobile() || z.addClass("fr-desktop"), z.appendTo("body"), b.shared.$overlay = a('<div class="fr-overlay">').appendTo("body"), F = b.shared.$overlay, b.opts.theme && F.addClass(b.opts.theme + "-theme"), d()),
        ...
        function l(c) {
            ...
            d.onload = function() {
                ...
                if (c.url && f.attr("data-url", c.url), c.tag) if (E.find(".fr-modal-more.fr-not-available").removeClass("fr-not-available"), E.find(".fr-modal-tags").show(), c.tag.indexOf(",") >= 0) {
                ...
                } else 0 === D.find('a[title="' + c.tag.trim() + '"]').length && D.append('<a role="button" title="' + c.tag.trim() + '">' + c.tag.trim() + "</a>"),
                f.attr("data-tag", c.tag.trim());
                for (var i in c) c.hasOwnProperty(i) && "thumb" != i && "url" != i && "tag" != i && f.attr("data-" + i, c[i]);
                e.append(f).append('<i class="fa fa-trash-o fr-delete-img" title="' + b.language.translate("Delete") + '"></i>').append('<i class="fa fa-plus fr-insert-img" title="' + b.language.translate("Insert") + '"></i>'),
                ...
                function() {
                    ...
                    o(a),
                    p(!1),
                    I % b.opts.imageManagerPageSize === 0 && k()
                }),
        ...
        function p(a) {
            ...
            C.height(Math.min(B.outerHeight(), g - i - j - m - l)),
            a && k()
        }
        function q(c) {
            ...
            if (d(), b.image.showProgressBar(), U) U.trigger("click");
                ...
                g = f.left + f.width / 2,
                h = f.top + f.height;
                b.popups.setContainer("image.insert", b.$box || a("body")),
                b.popups.show("image.insert", g, h)
            }
            var i = {},
            j = e.data();
            for (var k in j) j.hasOwnProperty(k) && "url" != k && "tag" != k && (i[k] = j[k]);
        ...
        function s(c, d) {
            c >= 10 && 20 > c ? A.hide() : c >= 20 && 30 > c && a(".fr-image-deleting").removeClass("fr-image-deleting"),
        ...
        function t() {
            ...
            b = D.outerHeight();
            E.toggleClass(".fr-show-tags"),
            E.hasClass(".fr-show-tags") ? (E.css("height", a + b), D.find("a").css("opacity", 1)) : (E.css("height", a), D.find("a").css("opacity", 0))
        }
        function u() {
        ...
        function x() {
            A = z.find("#fr-preloader"),
            B = z.find("#fr-image-list"),
            C = z.find("#fr-scroller"),
            D = z.find("#fr-modal-tags"),
            E = D.parent(),
            K = e(),
            f();
            ...
            E.css("height", c),
            C.css("margin-top", c),
            b.events.bindClick(z, "i#fr-modal-close", d),
            b.events.$on(a(b.o_win), "resize",
            function() {
                p(G ? !0 : !1)
            }),
            b.helpers.isMobile() && (b.events.bindClick(B, "div.fr-image-container",
            function(b) {
            ...
            b.events.bindClick(B, ".fr-insert-img", q),
            b.events.bindClick(B, ".fr-delete-img", r),
        ...
        S = 22,
        T = {};
        T[L] = "Image cannot be loaded from the passed link.",
