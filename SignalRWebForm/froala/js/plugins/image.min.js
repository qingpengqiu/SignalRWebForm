...
function(a) {
    ...
    a.extend(a.FE.DEFAULTS, {
        ...
        imageUploadURL: "/action/fileupload.ashx",
    ...
    a.FE.PLUGINS.image = function(b) {
        ...
        function d() {
            ...
            if (c || (c = J()), r(), !c.hasClass("fr-active")) if (b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", b.$tb), a.is(":visible")) {
        ...
        function g(a) {
            if (!a.hasClass("fr-dii") && !a.hasClass("fr-dib")) {
                var c = a.css("float");
                a.css("float", "none"),
                "block" == a.css("display") ? (a.css("float", c), b.opts.imageEditButtons.indexOf("imageAlign") >= 0 && (0 === parseInt(a.css("margin-left"), 10) && (a.attr("style") || "").indexOf("margin-right: auto") >= 0 ? a.addClass("fr-fil") : 0 === parseInt(a.css("margin-right"), 10) && (a.attr("style") || "").indexOf("margin-left: auto") >= 0 && a.addClass("fr-fir")), a.addClass("fr-dib")) : (a.css("float", c), b.opts.imageEditButtons.indexOf("imageAlign") >= 0 && ("left" == a.css("float") ? a.addClass("fr-fil") : "right" == a.css("float") && a.addClass("fr-fir")), a.addClass("fr-dii")),
                a.css("margin", ""),
                a.css("float", ""),
                a.css("display", ""),
                a.css("z-index", ""),
        ...
        function h() {
            for (var c = "IMG" == b.$el.get(0).tagName ? [b.$el.get(0)] : b.$el.get(0).querySelectorAll("img"), d = 0; d < c.length; d++) {
                var e = a(c[d]); (b.opts.imageEditButtons.indexOf("imageAlign") >= 0 || b.opts.imageEditButtons.indexOf("imageDisplay") >= 0) && g(e),
                e.attr("width") && (e.css("width", e.width()), e.removeAttr("width")),
        ...
        function i() {
            ...
            if (Ba) for (c = 0; c < Ba.length; c++) e.indexOf(Ba[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(Ba[c])]);
            Ba = d
        }
        function j() {
            pa || V();
        ...
        function l(c) {
            if (!b.core.sameInstance(pa)) return ! 0;
        ...
        function m(c) {
            ...
            if (qa && oa) {
                ...
                if ((qa.hasClass("fr-hnw") || qa.hasClass("fr-hsw")) && (f = 0 - f), b.opts.imageResizeWithPercent) {
                    ...
                    oa.css("width", g + "%")
                } else g + f >= b.opts.imageMinWidth && oa.css("width", g + f);
        ...
        function q(c) {
            ...
            if (d || (d = J()), b.popups.setContainer("image.insert", a(b.opts.scrollableContainer)), d.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), d.find(".fr-image-progress-bar-layer").addClass("fr-active"), d.find(".fr-buttons").hide(), oa) {
        ...
        function u() {
            var a = b.popups.get("image.insert"),
            c = a.find(".fr-image-by-url-layer input");
            c.val().length > 0 && (q(), s("Loading image"), x(b.helpers.sanitizeURL(c.val()), !0, [], oa), c.val(""), c.blur())
        }
        function v(a) {
            _.call(a.get(0))
        }
        ...
        function E(c, d, e) {
            ...
            function() {
                ...
                oa ? (oa.on("load", f), b.edit.on(), b.undo.saveStep(), oa.data("fr-old-src", oa.attr("src")), oa.attr("src", a)) : g = D(a, null, f)
            },
            !1),
            h.readAsDataURL(e)
        }
        function F(a) {
            ...
            if ("undefined" != typeof a && a.length > 0) {
                var c = a[0];
                if (c.size > b.opts.imageMaxSize) return o(xa),
                !1;
                if (b.opts.imageAllowedTypes.indexOf(c.type.replace(/image\//g, "")) < 0) return o(ya),
                !1;
                var d;
        ...
        function I() {
            b.events.$on(b.$el, b._mousedown, "IMG" == b.$el.get(0).tagName ? null: 'img:not([contenteditable="false"])',
            function(c) {
                return a(this).parents('[contenteditable="false"]:not(.fr-element):not(body)').length ? !0 : (b.selection.clear(), sa = !0, b.browser.msie && (b.events.disableBlur(), b.$el.attr("contenteditable", !1)), b.draggable || c.preventDefault(), void c.stopPropagation())
            }),
            b.events.$on(b.$el, b._mouseup, "IMG" == b.$el.get(0).tagName ? null: 'img:not([contenteditable="false"])',
            function(c) {
                return a(this).parents('[contenteditable="false"]:not(.fr-element):not(body)').length ? !0 : void(sa && (sa = !1, c.stopPropagation(), b.browser.msie && (b.$el.attr("contenteditable", !0), b.events.enableBlur())))
            }),
            b.events.on("drop", H),
        ...
        function M(a) {
            if (a) return b.popups.onRefresh("image.alt", K),
            !0;
            var c = "";
        ...
        function Q(a) {
            if (a) return b.popups.onRefresh("image.size", O),
            !0;
            var c = "";
        ...
        function S(a) {
            ...
            if (oa || b.opts.toolbarInline) oa && (d = oa.offset().top + oa.outerHeight());
            else {
            ...
            } ! oa && b.opts.toolbarInline && (d = e.offset().top - b.helpers.getPX(e.css("margin-top")), e.hasClass("fr-above") && (d += e.outerHeight())),
        ...
        function V() {
            var c;
            b.shared.$image_resizer ? (pa = b.shared.$image_resizer, ra = b.shared.$img_overlay, b.events.on("destroy",
            function() {
                pa.removeClass("fr-active").appendTo(a("body"))
            },
            !0)) : (b.shared.$image_resizer = a('<div class="fr-image-resizer"></div>'), pa = b.shared.$image_resizer, b.events.$on(pa, "mousedown",
            function(a) {
                a.stopPropagation()
            },
            !0), b.opts.imageResize && (pa.append(k("nw") + k("ne") + k("sw") + k("se")), b.shared.$img_overlay = a('<div class="fr-image-overlay"></div>'), ra = b.shared.$img_overlay, c = pa.get(0).ownerDocument, a(c).find("body").append(ra))),
            ...
            !0),
            b.helpers.isMobile() || b.events.$on(a(b.o_win), "resize",
            function() {
                oa && !oa.hasClass("fr-uploading") ? aa(!0) : oa && (j(), ja(), q(!1))
            }),
            b.opts.imageResize && (c = pa.get(0).ownerDocument, b.events.$on(pa, b._mousedown, ".fr-handler", l), b.events.$on(a(c), b._mousemove, m), b.events.$on(a(c.defaultView || c.parentWindow), b._mouseup, n), b.events.$on(ra, "mouseleave", n))
        }
        function W(c) {
            c = c || oa,
            c && b.events.trigger("image.beforeRemove", [c]) !== !1 && (b.popups.hideAll(), aa(!0), c.get(0) == b.$el.get(0) ? c.removeAttr("src") : ("A" == c.get(0).parentNode.tagName ? (b.selection.setBefore(c.get(0).parentNode) || b.selection.setAfter(c.get(0).parentNode), a(c.get(0).parentNode).remove()) : (b.selection.setBefore(c.get(0)) || b.selection.setAfter(c.get(0)), c.remove()), b.selection.restore(), b.html.fillEmptyBlocks()), b.undo.saveStep())
        }
        function X() {
            if (I(), "IMG" == b.$el.get(0).tagName && b.$el.addClass("fr-view"), b.events.$on(b.$el, b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend": "click", "IMG" == b.$el.get(0).tagName ? null: 'img:not([contenteditable="false"])', _), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "IMG" == b.$el.get(0).tagName ? null: 'img:not([contenteditable="false"])',
            function() {
                Ca = !1
            }), b.events.$on(b.$el, "touchmove",
            function() {
                Ca = !0
            })), b.events.on("window.keydown keydown",
            function(c) {
                var d = c.which;
                return ! oa || d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.DELETE ? oa && d == a.FE.KEYCODE.ESC ? (aa(!0), c.preventDefault(), !1) : oa && !b.keys.ctrlKey(c) ? (c.preventDefault(), !1) : void 0 : (c.preventDefault(), c.stopPropagation(), W(), !1)
            },
            !0), b.events.$on(a(b.o_win), "keydown",
            function(b) {
                var c = b.which;
                return oa && c == a.FE.KEYCODE.BACKSPACE ? (b.preventDefault(), !1) : void 0
            }), b.events.on("paste.before", Z), b.events.on("paste.beforeCleanup", $), b.events.on("paste.after", Y), b.events.on("html.set", h), h(), b.events.on("html.get",
            function(a) {
                ...
                function() {
                    ...
                    for (var d = 0; d < c.length; d++) c[d].setAttribute("width", a(c[d]).width()),
            ...
            function(a) {
                return "IMG" == a.get(0).tagName ? (W(a), !1) : void 0
            })
        }
        function Y() {
        ...
        function aa(a) {
            oa && (da() || a === !0) && (b.toolbar.enable(), pa.removeClass("fr-active"), b.popups.hide("image.edit"), oa = null, ca())
        }
        function ba() {
            Da = !0
        }
        ...
        function ja() {
            var c = b.popups.get("image.insert");
            c || (c = J()),
            b.popups.isVisible("image.insert") || (r(), b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", a(b.opts.scrollableContainer)));
            var d = oa.offset().left + oa.width() / 2,
            e = oa.offset().top + oa.height();
        ...
        function la() {
            oa ? (a(".fr-popup input:focus").blur(), v(oa)) : (b.events.disableBlur(), b.selection.restore(), b.events.enableBlur(), b.popups.hide("image.insert"), b.toolbar.showInline())
        }
        function ma() {
            return oa
        }
        function na(a, c, d) {
            if ("undefined" == typeof c && (c = b.opts.imageStyles), "undefined" == typeof d && (d = b.opts.imageMultipleStyles), !oa) return ! 1;
            if (!d) {
                var e = Object.keys(c);
