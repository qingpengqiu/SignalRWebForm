<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetOrderInfo.aspx.cs" Inherits="GroupBuy_GetOrderInfo" %>
...
<body>
    ...
    <div class="wrap">
        <article>
            ...
            <div id="payb">
                <asp:Button ID="ToNOPay" runat="server" Text="立即拼团" CssClass="topay" OnClick="ToNOPay_Click" Visible="False" />
            	<asp:Button ID="topay" runat="server" Text="" CssClass="alipeypay" OnClick="topay_Click" Visible="False" />
                <asp:Button ID="waptourpay" runat="server" Text="" CssClass="alipeypay" OnClick="waptourpay_Click" Visible="False" />
               <asp:Button ID="wxpay" runat="server" Text="" CssClass="weixinpay" OnClick="wxpay_Click" Visible="False"/>
                <asp:Button ID="wxsmpay" runat="server" Text="" CssClass="weixinpay" OnClick="wxsmpay_Click" Visible="False"/>
                <a href="/GroupBuy/Cart.aspx?id=<%=idGood %>&from=<%=idorder %>" class="returnbuy">返回修改订单</a>
            </div>
        </article> 
    </div>
    <script>
    ...
    <ERUN360:Erun_Footer runat="server" ID="Erun_Footer" />
          <%--  <script>
                window.onload = function () {
                    ...
                    if (wechatInfo) {                     
                    if (wechatInfo[1] > "5.0") {
                        window.location.href = '/weixinpay/wxorder.aspx?idorder=<%=idorder%>';
                        }
                    }
                }
    </script>--%>
