<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Group.aspx.cs" Inherits="GroupBuy_Group" %><%@ Register Src="~/Controls/Erun_Header.ascx" TagPrefix="ERUN360" TagName="Erun_Header" %><%@ Register Src="~/Controls/Erun_Left.ascx" TagPrefix="ERUN360" TagName="Erun_Left" %><%@ Register Src="~/Controls/Erun_Footer.ascx" TagPrefix="ERUN360" TagName="Erun_Footer" %><!DOCTYPE html>
<html xmlns:wb="http://open.weibo.com/wb">
<head>
    <link rel="shortcut icon" href="/Html/images/erun.png" type="image/x-icon" />
    <title><%=cname%>-拼团-益跑网个人中心</title>
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="groupnt groupnts">
                    <a href="/GroupBuy/GroupList.aspx">返回拼团首页>></a>
    		...
    		<div class="shopt">
                ...
                <div class="tpopn">
                    ...
                    <div class="tpopr">
<a class="ptbotton pingtuan" href="javascript:void(0)">立即拼团</a>
...
<div class="endtime"></div>
				...
				<div class="tuantip">
					玩转拼团<br>
				当拼团顾客达到一定数量则商品价格进入更低的价格阶梯，直至达到最低价或拼团结束
快叫你的跑友一起来冲击低价吧
（阶梯差价将在拼团结束后退回到先购买的顾客支付宝账户中）
...
$(document).ready(function(){
   ...
   var ptbottontit = Result[0].Tour[1]?'立即拼团':'立即秒杀'
...
$(".pingtuan").on('click', function(event) {
    window.location.href="Cart.aspx?id="+GetQueryString("id"); 
});
