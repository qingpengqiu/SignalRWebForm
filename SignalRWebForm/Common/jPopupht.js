...
document.write("<div id=\"msgDiv\" style=\"position:absolute;left:0;top:0;z-index:103;display:none;width:1px;height:1px;\"></div>");
document.write("<div id=\"bgDiv\" style=\"position:absolute;left:0;top:0;z-index:102;width:1px;height:1px;display:none;\"></div>");
...
function PopupShow(w, h, title, url) 
{
	...
	var str = "";
	str += "<div style=\"width:" + mWidth + "px;height:" + mHeight + "px;background:#fff;text-align:left;\">";
	str += "<div id=\"titleBar\">";
	str += "<a onclick=\"PopupClose()\" style=\"position: absolute;bottom: 27px;right: 27px;position: absolute;color: #666;text-decoration: underline;font-size: 14px; \">&#20851;&#38381;</a>";
	str += "</div>";
	str += "<iframe src=\"" + url + "\" width=\"" + mWidth + "\" height=\"" + mHeight + "\" border=\"0\" bordercolor=\"#000000\" frameborder=\"0\" scrolling=\"no\" allowTransparency=\"true\"></iframe>";
	str += "</div>";
