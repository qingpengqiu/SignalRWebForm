<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScorePay.aspx.cs" Inherits="Pay_Score_ScorePay" %>
...
.buylc .lc{background: url(/Html/images/ddlc.png) no-repeat left -250px;display: inline-block;height: 47px;width:684px;margin: 0 0px -4px 10px}
    </style>
    <form id="form1" runat="server">
        <div class="indecen">
            ...
            <table class="payrace">
                <tr>
                    <td ><em>订单号</em></td>
                    <td class="payrmb"><%=Request["idorder"].Trim()%>
                    </td>
                </tr>
                <tr>
                    <td ><em>商品信息</em></td>
