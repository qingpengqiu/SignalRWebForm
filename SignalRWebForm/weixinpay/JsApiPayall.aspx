<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JsApiPayall.aspx.cs" Inherits="weixinpay_JsApiPayall" %>
        ...
        <%=wxJsApiParam%>,//josn串
                ...
                {              
                    ...
                    if(res.err_msg == "get_brand_wcpay_request:ok" ) {                        
                        window.location.href="/Competetion/payok.aspx?sid=<%=sid%>&id=<%=id%>";//支付成功后的跳转页面
                    }else
                    {
            ...
            <article>
                <div class="sbox">
                    ...
                    <div class="spshow">
                        ...
                        您需要支付：<em><asp:Literal ID="ltlPrice" runat="server"></asp:Literal></em>元<em>(请于<asp:Literal ID="ltlMax" runat="server"></asp:Literal>之内完成付款)</em><br>
                    </div>
                </div>
                <div id="payb">
