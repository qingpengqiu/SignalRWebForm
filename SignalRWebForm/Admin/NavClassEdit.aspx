<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NavClassEdit.aspx.cs" Inherits="Admin_NavClassEdit" %>
...
<div class="cont">
	<div class="conttop">
		<a href="/" >首页</a>  >
<a href="/Admin/">管理首页</a>><a href="/Admin/NavClasslist.aspx">分类列表</a>>
		发布赛事
	</div>
<table>
    <tr>
    <td>
        <label for="">分类名称</label></td>
    <td>
    ...
    <td>
       ...
       <%-- <input type="text" tabindex="4" id="linkurl" name="name" runat="server" maxlength="512" />--%>
    </td>
</tr>
    <tr>
    <td>
...
<tr>
    ...
    <script type="text/javascript">
        $(".fileupload").change(function () {
            ...
            $.ajax({
                url: '/action/fileUp.ashx?name=NavClass',
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
