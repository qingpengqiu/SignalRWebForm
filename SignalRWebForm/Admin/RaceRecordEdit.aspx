<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RaceRecordEdit.aspx.cs" Inherits="Admin_RaceRecordEdit" %>
...
<div class="cont">
		<div class="conttop">
		<a href="/" >首页</a>  >
<a href="/Admin/RaceList.aspx">赛事首页</a>><a href="/Admin/RaceRecord.aspx">报名记录</a>>
		编辑
	</div>
    <a name='a<%=id %>>'></a>
      <table>
