<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FSCP.aspx.cs" Inherits="Admin_FSCP" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="cont">
            <div class="conttop">
                <a href="FSCPEdit.aspx?id=0" target="_blank" class="tnewuser">添加附属产品</a>
                <a href="/">首页</a> >
                    ...
                    <ItemTemplate>
                        <tr>
                           ...
                           <td><%# DataBinder.Eval(Container.DataItem, "cName")%></td>                            
                            ...
                            <td><a href='<%# "FSCPEdit.aspx?id="+DataBinder.Eval(Container.DataItem, "id") %>' target="_self">编辑</a>  <a href='<%# "FSCP.aspx?id="+DataBinder.Eval(Container.DataItem, "id") %>'>删除</a></td>
                        </tr>
                    </ItemTemplate>
