<%@ Page Language="C#" AutoEventWireup="true" CodeFile="flightgroom.aspx.cs" Inherits="Admin_flightgroom" %>
...
<a href="/Admin/RaceList.aspx">赛事首页</a>>
	...
	<!-- 信息输入开始 -->
	<form id="form1" name="form1" action="flightgroom.aspx" method="post">
	...
	<tr>
		<td style="border-top:dotted 1px #AAAAAA;padding:20px;padding-left:3px;color:#666666;font-size:12px;">
			...
			请参考下面实例输入首页赛事报名区块内容（HTML格式）：<br>
             &lt;div class="slisttr"&gt;<br>
        		&lt;div class="slisttrd"&gt;2015新加坡日落马拉松&lt;/div&gt;&lt;div class="slisttrd"&gt;新加坡&lt;/div&gt;&lt;div class="slisttrd">2015-07-04&lt;/div&gt;<br>
        	&lt;/div&gt;
		</td>
		<td colspan="2" align="left" valign="top" style="color:#5C6F9A;padding:20px;border-top:dotted 1px #AAAAAA;font-size:12px;">
			<br>
			&bull; 第一：2015新加坡日落马拉松 换成对应的赛事的名称。<br>
			• 第二：新加坡 换成对应的赛事的地点。<br>
            <br>
		</td>
	</tr>
	<tr>
