...
<body>
    <form id="form1" runat="server">
        ...
        <div class="cont">
            <div class="conttop">
                <a href="IntegralEdit.aspx" target="_blank" class="tnewuser">操作积分</a>
                <a href="/">首页</a> >
<a href="/Admin/PayList.aspx">物品管理首页</a>>
		积分查询
            ...
            <table>
		<tr>
			<td><label for="ssname">用户id：</label></td>
			<td>
                <asp:TextBox ID="txtUserID" runat="server"></asp:TextBox>
            </td>

			<td>
                <asp:Button ID="btQuery" runat="server" OnClick="btQuery_Click" Text="查询用户积分" />
            </td>
            <td>
