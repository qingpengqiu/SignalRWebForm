<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdEdit.aspx.cs" Inherits="Admin_AdEdit" %>
   ...
   <div class="indecen">
            <div class="newclub">
                <table>
                    ...
                    <tr>
                        <td>
                            <label for="">分词</label></td>
                        <td>
                            <textarea id="Idmsg" cols="20" rows="2" runat="server" maxlength="1024"></textarea>分词以|分割，例如：耐克|nike
                            <input type="text" id="b2" readonly="readonly" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="">广告图片</label></td>
                        <td>
                            <asp:FileUpload ID="ggtp" tabindex="3" runat="server" class="input-large" />(图片大小140x70)<img width="100" height="20" src="<%=cImg%>" /><!-- <asp:Label ID="lbtt" runat="server" Text="" ></asp:Label> -->
                        </td>
                    </tr>
                     <tr>
                        <td>
