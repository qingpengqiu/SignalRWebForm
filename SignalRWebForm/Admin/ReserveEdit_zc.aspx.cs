...
public partial class Admin_ReserveEdit : PageBase
{
    private int id = 0;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            AlertHelper.JQAlertGo("该物品不存在", "GoodList_zc.aspx", false);
            return;
        }
        ...
        if (id != 0)
        {
            ...
            {
                AlertHelper.JQAlertGo("修改成功！", "ReserveList_zc.aspx", true);
            }
            else
            {
        ...
        else
        {
            ...
            {
                AlertHelper.JQAlertGo("添加成功！", "ReserveList_zc.aspx", true);
            }
            else
            {
    ...
    {
        DataSet ds = new DB1.tblGoods().GetList(" iState>=0 and fReserve=1 and iType=1");
