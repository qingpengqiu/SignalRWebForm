<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RaceJionotherEdit.aspx.cs" Inherits="Admin_RaceJionotherEdit" %>
    ...
    <a name='a<%=id %>>'></a>
      <table>
        <tr>
            ...
            <td colspan="3">
                <input type="text" runat="server" value="" maxlength="16" tabindex="1" id="name" name="name"/></td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="mobile" id="mobile" value="" tabindex="2" runat="server" maxlength="11"/></td>
            <td>
                <label for="">地址</label></td>
            <td>
                 <input type="text" tabindex="12" id="cCityname" runat="server" readonly/>
            <input type="text" name="address" id="address" value="" tabindex="3" runat="server" maxlength="128"/>
            </td>
        </tr>
        <tr id="bz" runat="server">
            <td>
                <label for="">备注</label></td>
            <td colspan="3">
               <input type="text"  id="cMake2" value="" tabindex="4" runat="server" maxlength="128" />
           </td>
        </tr>
          <tr>
            <td> <label for="">审核批注</label>
               </td>
            <td>
