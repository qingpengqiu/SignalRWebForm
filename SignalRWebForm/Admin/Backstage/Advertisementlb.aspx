<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advertisementlb.aspx.cs" Inherits="Admin_Backstage_Advertisementlb" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="cont">
            <div class="conttop">
                <a href="Advertisement.aspx?id=0" target="_blank" class="tnewuser">添加广告</a>
               ...
               <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                       <tr>
                            ...
                            <td><%# GetNick(Eval("cPosition").ToString())%></td>
                            <td><%# Eval("cState").ToString()=="1"?"暂停":"正常"%></td>
                             <td><a href='<%# "Advertisement.aspx?id="+DataBinder.Eval(Container.DataItem, "id") %>' >编辑</a>
                             </td>
                        </tr>
                    </ItemTemplate>
