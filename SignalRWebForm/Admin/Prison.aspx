<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Prison.aspx.cs" Inherits="_Admin_Prison" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title>封锁用户账户-数据维护-ERUN360.COM</title>
...
<!-- 信息开始 -->
<form id="form1" name="form1" action="Prison.aspx" method="post" autocomplete="off">
...
<tr>
	<td align="right" valign="top">相关：</td>
	<td>
		<input type="checkbox" id="operations" name="operations" value="blog" checked>删除TA的全部博客<br>
		<input type="checkbox" id="operations" name="operations" value="discuss" checked>删除TA的全部评论<br>
		<input type="checkbox" id="operations" name="operations" value="image" checked>删除TA的全部图片<br>
	</td>
</tr>
<tr>
	<td align="right" valign="top"></td>
