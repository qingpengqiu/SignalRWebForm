<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="News.aspx.cs" Inherits="_Admin_News" %>
...
<div style="width:930px;height:600px;padding:10px;text-align:left;">
	...
	<!-- 信息输入开始 -->
	<form id="form1" name="form1" action="News.aspx" method="post">
...
&lt;/ul&gt;
	...
	<tr>
		...
		<td>
			<style>
			#preview { width:330px;height:340px;padding-top:5px;text-align:left;overflow:hidden; }
