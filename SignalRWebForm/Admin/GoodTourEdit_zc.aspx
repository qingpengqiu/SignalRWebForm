<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodTourEdit_zc.aspx.cs" Inherits="Admin_GoodTourEdit" %>
<!DOCTYPE html>
...
<a href="/Admin/GoodList_zc.aspx">商品列表</a>>
		编辑商品
	</div>
   <div class="indecen">
            <div class="newclub">
                <table>
                     <tr>
                        ...
                        <td>
                            <select id="itpye" runat="server"> 
                                
                                <option value="3"  selected="selected">众筹商品</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <label for="">众筹人数</label></td>
                        <td>
                            <input type="text" tabindex="4" id="iTourNum" name="name" runat="server" maxlength="10" /><label for="">个</label>（默认众筹人数不能超过5人(没人购买时的显示数)）
                        </td>
                    </tr>
                      <tr>
                        <td>
