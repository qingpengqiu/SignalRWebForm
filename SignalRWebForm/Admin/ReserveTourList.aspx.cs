...
public partial class Admin_ReserveTourList : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (idgood != 0)
            {
                ds = new DB1.tblReserve().GetList(0, "iType=2 and idGood=" + idgood, "idGood desc,cSize");
            }
            else
            {
                ds = new DB1.tblReserve().GetList(0, "iType=2", "idGood desc,cSize");
            }
