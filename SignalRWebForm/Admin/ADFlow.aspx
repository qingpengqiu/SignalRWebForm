<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ADFlow.aspx.cs" Inherits="Admin_ADFlow" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="cont">
            <div class="conttop">
                <a href="ADFlowEdit.aspx?id=0" target="_blank" class="tnewuser">添加广告流</a>
                <a href="/">首页</a> >
<a href="/admin/">管理首页</a> > 
		广告流
            </div>
                    ...
                    <ItemTemplate>
                        <tr>
                           ...
                           <td><%# DataBinder.Eval(Container.DataItem, "cName")%></td>
                            ...
                            <%--<td><%# DataBinder.Eval(Container.DataItem, "iType")%></td>--%>
                            <td><%#GetChannelName( Eval("idChannel").ToString())%></td>
                            <td><%# DataBinder.Eval(Container.DataItem, "iPage")%></td>
                            <td><%# DataBinder.Eval(Container.DataItem, "iIndex")%></td>
                            <td  style="width:100px;"><%# DataBinder.Eval(Container.DataItem, "cHtml")%></td>
                            
                            <td><%#string.Format("{0:yyyy-MM-dd HH:mm}",Eval("dBegintime"))%></td>
                            <td><%#string.Format("{0:yyyy-MM-dd HH:mm}",Eval("dEndtime"))%></td>
                             <td><%# Eval("iShow").ToString() == "0" ? "<font color=\"red\">全部</font>" : Eval("iShow").ToString() == "1"?"<font color=\"#B23AEE\">电脑</font>":Eval("iShow").ToString() == "2" ? "<font color=\"#008800\">手机</font>":""%></td>
                            <td><a href='<%# "ADFlowEdit.aspx?id="+DataBinder.Eval(Container.DataItem, "id") %>' target="_self">编辑</a></td>
                        </tr>
                    </ItemTemplate>
