<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodShopList.aspx.cs" Inherits="Admin_GoodShopList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="cont">
            <div class="conttop">
                <a href="GoodTourEdit.aspx?id=0" target="_blank" class="tnewuser">添加拼团商品</a>
                <a href="/">首页</a> ><a href="/Admin/PayList.aspx">物品管理首页</a>>拼团商品管理
            </div>
            <div class="auditclub">
                    ...
                    <ItemTemplate>
                       <tr>
                           ...
                           <td><%#  Eval("fScore").ToString() == "1" ?  Eval("iScore").ToString()+"+"+ Eval("iMoney").ToString(): "否"%></td>                            
                            ...
                            <td><a href='<%#"GoodTourEdit.aspx?id="+DataBinder.Eval(Container.DataItem, "id")%>' target="_self">编辑</a>  <a href='<%# "GoodDetail.aspx?id="+DataBinder.Eval(Container.DataItem, "id") %>' target="_blank">查看</a></td>
                            <td><%# isReserve( Eval("id").ToString())==0?"<a href='ReserveTourEdit.aspx?id=0&idgood="+DataBinder.Eval(Container.DataItem, "id")+"' target=\"_blank\"><span class=\"tip\">添加库存</span></a>":"<a href='ReserveTourList.aspx?idgood="+DataBinder.Eval(Container.DataItem, "id")+"' target=\"_blank\">查看库存</a>" %></td>
                           <td><%# istour( Eval("id").ToString(), Eval("iType").ToString())==-1?"":istour( Eval("id").ToString(), Eval("iType").ToString())==0?"<a href='TourEdit.aspx?id=0&idgood="+DataBinder.Eval(Container.DataItem, "id")+"' target=\"_blank\"><span class=\"tip\">添加拼团</span></a>":"<a href='TourList.aspx?idgood="+DataBinder.Eval(Container.DataItem, "id")+"' target=\"_blank\">查看拼团</a>" %></td>
                        </tr>
                        </tr>
                    </ItemTemplate>
