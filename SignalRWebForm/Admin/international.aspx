<%@ Page Language="C#" AutoEventWireup="true" CodeFile="international.aspx.cs" Inherits="Admin_international" %>
...
<a href="/Admin/RaceList.aspx">赛事首页</a>>
	...
	<!-- 信息输入开始 -->
	<form id="form1" name="form1" action="international.aspx" method="post">
	...
	<tr>
		<td style="border-top:dotted 1px #AAAAAA;padding:20px;padding-left:3px;color:#666666;font-size:12px;">
            ...
            &lt;a class="title" target="_blank" href="/blog/200018532.aspx"&gt;蒲甘千佛塔马拉松&lt;/a&gt;<br />
            &lt;a class="title" target="_blank" href="/blog/200018532.aspx"&gt;蒲甘千佛塔马拉松&lt;/a&gt;<br />
            &lt;a class="title" target="_blank" href="/blog/200018532.aspx"&gt;蒲甘千佛塔马拉松&lt;/a&gt;<br>
