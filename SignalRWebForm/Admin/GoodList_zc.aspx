<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodList_zc.aspx.cs" Inherits="Admin_GoodList" %>
               ...
               <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                       <tr>
                           ...
                           <td> <%#  Eval("iType").ToString() == "1" ? "积分兑换": Eval("iType").ToString() == "3" ? "众筹商品":"普通商品"%>  </td>                            
                           ...
                           <td><%# DataBinder.Eval(Container.DataItem, "iTotal")%></td>
                            <td><a href='<%#istour( Eval("id").ToString(), Eval("iType").ToString())==-1?"GoodEdit_zc.aspx?id="+DataBinder.Eval(Container.DataItem, "id"):"GoodTourEdit_zc.aspx?id="+DataBinder.Eval(Container.DataItem, "id")%>' target="_self">编辑</a><a href='<%# "GoodDetail_zc.aspx?id="+DataBinder.Eval(Container.DataItem, "id") %>' target="_blank">查看</a></td>
                            <td><%# isReserve( Eval("id").ToString())==0?"<a href='ReserveEdit_zc.aspx?id=0&idgood="+DataBinder.Eval(Container.DataItem, "id")+"' target=\"_blank\"><span class=\"tip\">添加库存</span></a>":"<a href='ReserveList_zc.aspx?idgood="+DataBinder.Eval(Container.DataItem, "id")+"' target=\"_blank\">查看库存</a>" %></td>
                        </tr>
                        </tr>
                    </ItemTemplate>
