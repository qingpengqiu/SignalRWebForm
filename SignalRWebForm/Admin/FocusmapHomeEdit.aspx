<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FocusmapHomeEdit.aspx.cs" Inherits="Admin_FocusmapHomeEdit" %>
...
<div class="cont">
	<div class="conttop">
		<a href="/">首页</a> >
<a href="/admin/">管理首页</a> > 
        <a href="/admin/FocusmapHome.aspx">焦点图列表</a> > 
		编辑首页焦点图
	</div>
   <div class="indecen">
            <div class="newclub">
                <table>
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                            <asp:FileUpload ID="ggtp" tabindex="3" runat="server" class="input-large" />(首页720*360其他频道页840*360)<img width="100" height="20" src="<%=cImg%>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
