<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RaceJionEdit.aspx.cs" Inherits="Admin_RaceJionEdit" %>
    ...
    <a name='a<%=id %>>'></a>
      <table>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="idgj" id="idgj" value="" tabindex="7" runat="server" />
            </td>
                <td>
        ...
        <tr>
            ...
            <td><input type="text" name="bz1" id="bz1" value="" runat="server"/></td>
            <td><label for="">位置2</label></td>
            <td><input type="text" name="bz2" id="bz2" value="" runat="server"/></td>
        </tr>
          <tr>
            <td><label for="">位置3</label></td>
            <td><input type="text" name="bz3" id="bz3" value="" runat="server"/></td>
            <td><label for="">位置4</label></td>
            <td><input type="text" name="bz4" id="bz4" value="" runat="server"/></td>
        </tr>
           <tr>
            <td><label for="">位置5</label></td>
            <td><input type="text" name="bz5" id="bz5" value="" runat="server"/></td>
            <td></td>
            <td></td>
        </tr>
    </table>
